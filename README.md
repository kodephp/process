...
| 指标 | Swoole | Kode Process | Workerman |
|------|--------|--------------|-----------|
| **HTTP QPS** | 65,000 | 55,000 | 45,000 |
| **WebSocket 连接** | 150,000 | 120,000 | 100,000 |
| **TCP QPS** | 100,000 | 80,000 | 70,000 |
| **Fiber 创建** | 200,000/s | 139,000/s | ~100,000/s |
| **内存/进程** | ~4MB | ~8MB | ~10MB |
| **跨平台** | ⚠️ 有限 | ⚠️ 单进程 | ⚠️ 单进程 |
