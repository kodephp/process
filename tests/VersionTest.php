...
final class VersionTest extends TestCase
{
    ...
    {
        $this->assertSame(40100, Version::getId());
    }
    ...
    public function testGetInfoStructure(): void
    {
        ...
        $this->assertSame(40100, $info['version_id']);
    ...
    {
        $this->assertTrue(Version::isEqualTo('4.1.0'));
        $this->assertTrue(Version::isGreaterThan('2.9.0'));
        $this->assertTrue(Version::isLessThan('4.2.0'));
        $this->assertFalse(Version::isGreaterThan('4.1.0'));
    }

    public function testToString(): void
    {
        $this->assertSame('4.1.0', (string) new Version());
    }
}
