...
final class VersionTest extends TestCase
{
    ...
    {
        $this->assertSame(50104, Version::getId());
    }
    ...
    public function testGetInfoStructure(): void
    {
        ...
        $this->assertSame('5.1.4', $info['version']);
        $this->assertSame(50104, $info['version_id']);
    ...
    {
        $this->assertTrue(Version::isEqualTo('5.1.4'));
        $this->assertTrue(Version::isGreaterThan('2.9.0'));
        $this->assertTrue(Version::isLessThan('5.2.0'));
        $this->assertFalse(Version::isGreaterThan('5.1.4'));
    }

    public function testToString(): void
    {
        $this->assertSame('5.1.4', (string) new Version());
    }
}
