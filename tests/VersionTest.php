...
final class VersionTest extends TestCase
{
    ...
    {
        $this->assertSame(50000, Version::getId());
    }
    ...
    public function testGetInfoStructure(): void
    {
        ...
        $this->assertSame(50000, $info['version_id']);
    ...
    {
        $this->assertTrue(Version::isEqualTo('5.0.0'));
        $this->assertTrue(Version::isGreaterThan('2.9.0'));
        $this->assertTrue(Version::isLessThan('5.1.0'));
        $this->assertFalse(Version::isGreaterThan('5.0.0'));
    }

    public function testToString(): void
    {
        $this->assertSame('5.0.0', (string) new Version());
    }
}
