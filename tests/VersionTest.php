...
final class VersionTest extends TestCase
{
    ...
    {
        $this->assertSame(50234, Version::getId());
    }
    ...
    public function testGetInfoStructure(): void
    {
        ...
        $this->assertSame('5.2.34', $info['version']);
        $this->assertSame(50234, $info['version_id']);
    ...
    {
        $this->assertTrue(Version::isEqualTo('5.2.34'));
        $this->assertTrue(Version::isGreaterThan('2.9.0'));
        // 用一个不可能达到的版本，避免每次发版都要回来改这行
        $this->assertTrue(Version::isLessThan('99.0.0'));
        $this->assertFalse(Version::isGreaterThan('5.2.34'));
    }

    public function testToString(): void
    {
        $this->assertSame('5.2.34', (string) new Version());
    }
}
