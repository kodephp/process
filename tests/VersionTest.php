...
final class VersionTest extends TestCase
{
    ...
    {
        $this->assertSame(40000, Version::getId());
    }
    ...
    public function testGetInfoStructure(): void
    {
        ...
        $this->assertSame('4.0.0', $info['version']);
        $this->assertSame(40000, $info['version_id']);
    ...
    {
        $this->assertTrue(Version::isEqualTo('4.0.0'));
        $this->assertTrue(Version::isGreaterThan('2.9.0'));
        $this->assertTrue(Version::isLessThan('4.1.0'));
        $this->assertFalse(Version::isGreaterThan('4.0.0'));
    }

    public function testToString(): void
    {
        $this->assertSame('4.0.0', (string) new Version());
    }
}
